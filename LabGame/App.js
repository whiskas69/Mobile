...
export default function App() {
  ...
  if (correctNumber > 0 && guessRounds <= 0) {
    ...
    content = (
      <GameScreen correctNumber={correctNumber} countRound={gameOverHandler}  />
    );
    
  } else if (guessRounds > 0) {
    // ทำการเรียก GameOverScreen
    content = (
      <GameOverScreen round={guessRounds} newGame={configureNewGameHandler} correctNumber={correctNumber} />
    );
  }
