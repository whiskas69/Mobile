...
const GameScreen = (props) => {
  ...
  if (confirmed && selectedNumber < correctNumber) {
    confirmedOutput = (
      <View style={styles.resultContainer}>
        ...
        <Text>The answer is greater. Rounds: {rounds}</Text>
      </View>
    );
  } else if (confirmed && selectedNumber > correctNumber) {
    confirmedOutput = (
      <View style={styles.resultContainer}>
        <Text>You selected</Text>
        <View style={styles.numberContainer}>
        ...
        <Text>The answer is lower. Rounds: {rounds}</Text>
      </View>
    );
  } else if (confirmed && selectedNumber === correctNumber) {
